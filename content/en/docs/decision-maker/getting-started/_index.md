  ...
  <div class="col">
    <div class="card h-100 border-success">
      <div class="card-body">
        ...
        <p class="card-text small mb-0">Display group exercise, swim lessons, and facility schedules in real-time.</p>
      </div>
    </div>
  </div>
  <div class="col">
...
[**→ DIY Installation Guide**](/docs/site-builder/getting-started/)
